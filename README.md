...
- Commands: `/workbench:bug-hunt`, `/workbench:frontier`, `/workbench:grilling`, `/workbench:plan`, `/workbench:prototype`, `/workbench:qc`, `/workbench:research`, `/workbench:run-plan`, `/workbench:tdd`, `/workbench:verify-specs`, `/workbench:write-adr`, `/workbench:write-hooks`, `/workbench:write-plan`, `/workbench:write-qa`, `/workbench:write-skills`, `/workbench:write-specs`
- Model-loaded skills: `clean-code`
